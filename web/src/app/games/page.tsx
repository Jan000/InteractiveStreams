...
const GAME_FIELDS: Record<string, Array<{
  ...
  gravity_brawl: [
    ...
    { key: "camera_zoom_speed", label: "Camera Zoom Speed", description: "How quickly the camera adjusts zoom level (higher = faster)", type: "float", min: 0.1, max: 10, step: 0.1, defaultValue: 3.5 },
    { key: "camera_buffer_meters", label: "Screen Margin (m)", description: "Buffer zone around players for mobile safe area (higher = more margin)", type: "float", min: 0, max: 15, step: 0.5, defaultValue: 1.5 },
    { key: "camera_min_zoom", label: "Camera Min Zoom", description: "Minimum zoom level (lower = camera can zoom out further)", type: "float", min: 0.1, max: 1.0, step: 0.05, defaultValue: 0.3 },
    { key: "camera_max_zoom", label: "Camera Max Zoom", description: "Maximum zoom-in level when players are clustered together", type: "float", min: 1.0, max: 5.0, step: 0.1, defaultValue: 2.5 },
    { key: "tier_radius_asteroid", label: "Asteroid Size", description: "Visual radius of Asteroid tier planets (meters)", type: "float", min: 0.1, max: 3.0, step: 0.05, defaultValue: 0.5 },
    { key: "tier_radius_ice", label: "Ice Planet Size", description: "Visual radius of Ice Planet tier (meters)", type: "float", min: 0.1, max: 3.0, step: 0.05, defaultValue: 0.7 },
    { key: "tier_radius_gas", label: "Gas Giant Size", description: "Visual radius of Gas Giant tier (meters)", type: "float", min: 0.1, max: 3.0, step: 0.05, defaultValue: 0.95 },
    { key: "tier_radius_star", label: "Star Size", description: "Visual radius of Star tier (meters)", type: "float", min: 0.1, max: 3.0, step: 0.05, defaultValue: 1.25 },
